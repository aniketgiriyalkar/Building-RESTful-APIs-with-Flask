...
app.config['JWT_SECRET_KEY'] = 'super-secret' # change in real time use
# app.config['MAIL_SERVER'] = 'smtp.mailtrap.io'
# app.config['MAIL_USERNAME'] = os.environ['MAIL_USERNAME']
# app.config['MAIL_PASSWORD'] = os.environ['MAIL_PASSWORD']
app.config['MAIL_SERVER']='smtp.mailtrap.io'
app.config['MAIL_PORT'] = 2525
app.config['MAIL_USERNAME'] = 'd33fbaa754a505'
app.config['MAIL_PASSWORD'] = '1aa752fc522246'
...
def retrieve_password(email: str):
    ...
    if user:
        msg = Message("Your planetary APT password is " + user.password,
